...
async function createTables() {
  ...
  try {
    ...
    try {
      // WICHTIG: Zuerst Benutzer-Tabelle erstellen
      await pool.query(`
      ...
      `);
      console.log('Benutzer-Tabelle erfolgreich erstellt oder existiert bereits');

      // Dann Trades-Tabelle erstellen mit Referenz auf users
      await pool.query(`
      ...
      `);
      console.log('Trades-Tabelle erfolgreich erstellt oder existiert bereits');
      ...
      `);
      console.log('Settings-Tabelle erfolgreich erstellt oder existiert bereits');
      ...
      `);
      console.log('Weekly-Summary-Tabelle erfolgreich erstellt oder existiert bereits');
      ...
      // Trotz Fehler weitermachen, um andere Tabellen zu erstellen
    }
